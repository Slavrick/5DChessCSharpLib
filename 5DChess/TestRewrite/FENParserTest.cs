...
namespace TestRewrite
{
	...
	public static class FENParserTest
	{
		public static void TestMoveParser()
		{
			...
			CoordFive x = FENParserRewrite.ParseRawCoordinate("(0,0,0,0)");
			if (!new CoordFive(0, 0, 0, 0).Equals(x)) throw new Exception(x.ToString());
			x = FENParserRewrite.ParseRawCoordinate("(10,5,10,5)");
			if (!new CoordFive(10, 5, 10, 5).Equals(x)) throw new Exception(x.ToString());
			x = FENParserRewrite.ParseRawCoordinate("(-10,-5,-2,-1)");
		...
		public static void TestSANParser()
		{
			...
			string san3 = "e4";
			string san4 = "m42";
            CoordFive c1 = FENParserRewrite.SANToCoord(san1);
			CoordFive c2 = FENParserRewrite.SANToCoord(san2);
			CoordFive c3 = FENParserRewrite.SANToCoord(san3);
			CoordFive c4 = FENParserRewrite.SANToCoord(san4);
		...
		public static void TestShadParser()
		{
			...
			CoordFive h1 = FENParserRewrite.HalfStringToCoord("(0T0)a1", false);
			CoordFive h2 = FENParserRewrite.HalfStringToCoord("(0T0)Na1", false);
			CoordFive h3 = FENParserRewrite.HalfStringToCoord("(0T1)e3", false);
			CoordFive h4 = FENParserRewrite.HalfStringToCoord("(-1T3)Nh7", false);
			CoordFive h5 = FENParserRewrite.HalfStringToCoord("(-0T3)Nh7", true);
            ...
            Move f1 = FENParserRewrite.FullStringToCoord("(0T1)Ng1(0T1)f3", false);
			Move f2 = FENParserRewrite.FullStringToCoord("(0T3)Ng1>(0T2)g3", false);
			Move f3 = FENParserRewrite.FullStringToCoord("(0T5)Qc3>>(0T1)f7", false);
		...
		public static void TestShadFEN()
		{
			...
			FENParserRewrite.ShadSTDGSM("C:\\Users\\mavmi\\Documents\\5DRewrite\\5DChess\\5DChess\\PGN\\Puzzles\\Brawn Tactics 1.5DPGN.txt");
			FENParserRewrite.ShadSTDGSM("C:\\Users\\mavmi\\Documents\\5DRewrite\\5DChess\\5DChess\\PGN\\testPGNs\\AmbiguityCheck.txt");
			Console.WriteLine(" passed.");
		}
		...
		public static void TestAmbiguityInfoParser()
		{
			...
			CoordFive t1 = FENParserRewrite.GetAmbiguityInfo("Ng3");
			CoordTester.TestCoord(t1, -1, -1, -1, -1);
			CoordFive t2 = FENParserRewrite.GetAmbiguityInfo("Nfg3");
			CoordTester.TestCoord(t2, 5, -1, -1, -1);
			CoordFive t3 = FENParserRewrite.GetAmbiguityInfo("N3g3");
			CoordTester.TestCoord(t3, -1, 2, -1, -1);
			CoordFive t4 = FENParserRewrite.GetAmbiguityInfo("Nc5g3");
			CoordTester.TestCoord(t4, 2, 4, -1, -1);
			CoordFive t5 = FENParserRewrite.GetAmbiguityInfo("(0T1)N1g3");
